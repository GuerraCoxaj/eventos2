            ...
            <table class="table table-hover table-borderless">
                <thead>
                    <tr>
                        ...
                        <th v-for="(Hora, index) in TableThead" :key="index">{{Hora+':00'}}</th>
                    </tr>
                </thead>
                <tbody v-for="(channel, index) in EventData.channels" :key="index">
                    <tr v-for="(room, indexRoom) in channel.rooms" :key="indexRoom">
                        ...
                        <td v-for="(Hora, indexHora) in TableThead" :key="indexHora">
                            <ColumnaTable :Hora="Hora" :Sesiones="room.sessions"></ColumnaTable>
                        </td>
                    </tr>
                </tbody>
            </table>
...
import ColumnaTable from './column-table.vue'
export default {
    name: 'TableEvent',
    components:{
        ColumnaTable
